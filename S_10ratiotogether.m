...
for i=1:N(10)
F10(i)=(1-B10(i))*E010(i)+B10(i)*(a1*mean(F11)+a2*mean(F12_)+a2*mean(F21)+a3*mean(F22_)+a3*mean(F31)+a4*mean(F32_)+a4*mean(F41)+a5*mean(F42_)+a5*mean(F51)+a6*mean(F52_)+a6*mean(F61)+a7*mean(F62_)+a7*mean(F71)+a8*mean(F72_)+a8*mean(F81)+a9*mean(F82_)+a9*mean(F91));
end
