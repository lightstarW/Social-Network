...
scatter(11*ones(1,length(F_111)),F_111,'.b');
hold on
F_112=F_11(find(F_11>=70));
scatter(11*ones(1,length(F_112)),F_112,'.r');
hold on
%第十二批次
...
scatter(12*ones(1,length(F_121)),F_121,'.b');
hold on
F_122=F_12(find(F_12>=70));
scatter(12*ones(1,length(F_122)),F_122,'.r');
hold on
%第十三批次
...
scatter(13*ones(1,length(F_131)),F_131,'.b');
hold on
F_132=F_13(find(F_13>=70));
scatter(13*ones(1,length(F_132)),F_132,'.r');
hold on
%第十四批次
...
scatter(14*ones(1,length(F_141)),F_141,'.b');
hold on
F_142=F_14(find(F_14>=70));
scatter(14*ones(1,length(F_142)),F_142,'.r');
hold on
%第十五批次
...
scatter(15*ones(1,length(F_151)),F_151,'.b');
hold on
F_152=F_15(find(F_15>=70));
scatter(15*ones(1,length(F_152)),F_152,'.r');
hold on
%第十六批次
...
scatter(16*ones(1,length(F_161)),F_161,'.b');
hold on
F_162=F_16(find(F_16>=70));
scatter(16*ones(1,length(F_162)),F_162,'.r');
hold on
%第十七批次
...
scatter(17*ones(1,length(F_171)),F_171,'.b');
hold on
F_172=F_17(find(F_17>=70));
scatter(17*ones(1,length(F_172)),F_172,'.r');
hold on
%第十八批次
...
scatter(18*ones(1,length(F_181)),F_181,'.b');
hold on
F_182=F_18(find(F_18>=70));
scatter(18*ones(1,length(F_182)),F_182,'.r');
hold on
...
scatter(19*ones(1,length(F_191)),F_191,'.b');
hold on
F_192=F_19(find(F_19>=70));
scatter(19*ones(1,length(F_192)),F_192,'.r');
hold on
%第二十批次
...
scatter(20*ones(1,length(F_201)),F_201,'.b');
hold on
F_202=F_20(find(F_20>=70));
scatter(20*ones(1,length(F_202)),F_202,'.r');
hold on